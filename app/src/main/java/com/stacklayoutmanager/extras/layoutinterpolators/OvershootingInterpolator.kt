package com.stacklayoutmanager.extras.layoutinterpolators
 ...
 *
 * Preview: https://raw.githubusercontent.com/DarkionAvey/StackLayoutManager/master/Showcase/gifs/overshooting_interpolator.webp
 */
class OvershootingInterpolator : FreePathInterpolator(layoutPath) {
    companion object {
        private val layoutPath: Path = Path().apply {
